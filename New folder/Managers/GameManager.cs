...
namespace SDEV248Midterm
{
    public class GameManager
    {
        ...
        static void StartGame()
        {
            ...
            Console.WriteLine("Welcome Nobel Warrior, you have been tasked by his royal highness to save his beloved daughter from the evil sorcerer Trogdar."); 
            Console.WriteLine("He shall be found in his castle upon the highest peak south of the kingdom. ");
            Console.WriteLine("Good luck and if you succeed you'll be rewarded handsomely.");
            Consol.WriteLine("As you finish reading the letter, you look up and see ");
            Console.WriteLine("That apon the jagged peaks of the mountain, cloaked in perpetual mist and shrouded by ancient pines, stands a Obsidian Spire.");
            Console.WriteLine(" Its twisted spires pierce the heavens like skeletal fingers, reaching for forbidden knowledge hidden among the stars.");
            Console.WriteLine("The castle is a nightmare in stone, its walls hewn from black obsidian, casting the fortress into perpetual twilight.");
            Console.WriteLine("Gargoyles leer from every corner, their eyes glowing with malevolence. Their wings are tattered, as if they’ve witnessed centuries of suffering.");
            Console.WriteLine("The entrance is a massive iron gate, adorned with twisted runes that writhe like serpents when touched.");
            Console.WriteLine("You ready yourself as you enter");
